...
export default function Orphanage() {
  ...
  useEffect(() => {
    api.get(`orphanages/${params.id}`).then(res => {
      setOrphange(res.data)
    })
  }, [params.id]); //toda vez que usar uma variavel dentro da função useEffect, colocar a variavel dentro dos colchetes finais
